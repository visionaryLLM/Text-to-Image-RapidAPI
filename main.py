...
GRADIO_URL = "https://playgroundai-playground-v2-5.hf.space/--replicas/mahpj/"
...
def generate_image():
    try:
        ...
        image_url = "https://playgroundai-playground-v2-5.hf.space/--replicas/mahpj/file=" + images[0]["image"]
