...
GRADIO_URL = "https://playgroundai-playground-v2-5.hf.space/--replicas/jzk7i/"
...
def generate_image():
    try:
        ...
        image_url = "https://playgroundai-playground-v2-5.hf.space/--replicas/jzk7i/file=" + images[0]["image"]
