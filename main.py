...
GRADIO_URL = "https://playgroundai-playground-v2-5.hf.space/--replicas/ktsmh/"
...
def generate_image():
    try:
        ...
        image_url = "https://playgroundai-playground-v2-5.hf.space/--replicas/ktsmh/file=" + images[0]["image"]
