...
GRADIO_URL = "https://playgroundai-playground-v2-5.hf.space/--replicas/pu7py/"
...
def generate_image():
    try:
        ...
        image_url = "https://playgroundai-playground-v2-5.hf.space/--replicas/pu7py/file=" + images[0]["image"]
